  ...
  return (
    ...
    >
      <img
        ...
        src="./themes/Felix/status/cof_orange_hex.svg"
        alt="Ubuntu Logo"
      />
      <div
      ...
      >
        {props.isShutDown ? (
          <div className="bg-white rounded-full flex justify-center items-center w-10 h-10 hover:bg-gray-300">
            <img
              className="w-8"
              src="./themes/Felix/status/power-button.svg"
              alt="Power Button"
            />
          </div>
        ) : (
          <img
            ...
            src="./themes/Felix/status/process-working-symbolic.svg"
      ...
      <img
        ...
        src="./themes/Felix/status/ubuntu_white_hex.svg"
        alt="Ubuntu Name"
      />
      <div className="text-white mb-4">
        <a
          className="underline"
          href="https://www.linkedin.com/in/felixnyamweya/"
        ...
        <a
          href="https://github.com/fnyamweya/"
          rel="noreferrer noopener"
          target="_blank"
          className="underline"
        >
