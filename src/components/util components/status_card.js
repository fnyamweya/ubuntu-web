    ...
    return (
      ...
      >
        ...
        <div className="w-64 py-1.5 flex items-center justify-center bg-ub-cool-grey hover:bg-ub-warm-grey hover:bg-opacity-20">
          <div className="w-8">
            <img
              src="./themes/Felix/status/audio-headphones-symbolic.svg"
        ...
        <div className="w-64 py-1.5 flex items-center justify-center bg-ub-cool-grey hover:bg-ub-warm-grey hover:bg-opacity-20">
          <div className="w-8">
            <img
              src="./themes/Felix/status/display-brightness-symbolic.svg"
        ...
        <div className="w-64 py-1.5 flex items-center justify-center bg-ub-cool-grey hover:bg-ub-warm-grey hover:bg-opacity-20">
          <div className="w-8">
            <img
              src="./themes/Felix/status/bluetooth-symbolic.svg"
        ...
        >
          <div className="w-8">
            <img
              src="./themes/Felix/status/emblem-system-symbolic.svg"
              alt="ubuntu settings"
            />
          </div>
        ...
        >
          <div className="w-8">
            <img
              src="./themes/Felix/status/changes-prevent-symbolic.svg"
              alt="ubuntu lock"
            />
          </div>
          <div className="w-2/3 flex items-center justify-between">
        ...
        >
          <div className="w-8">
            <img
              src="./themes/Felix/status/system-shutdown-symbolic.svg"
              alt="ubuntu power"
            />
          </div>
          <div className="w-2/3 flex items-center justify-between">
